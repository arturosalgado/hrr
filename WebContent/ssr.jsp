            ...
            <div class="z-window-embedded-cl">
               <div class="z-window-embedded-cr">
                  <div class="z-window-embedded-cm">
                     <div id="mXDP1-cave" class="z-window-embedded-cnt">
                           ...
                           <tbody>
                              <tr valign="top">
                                 <td id="mXDP2-frame" style="width:100%;height:100%" align="left">
                                    <table id="mXDP2-real" cellpadding="0" cellspacing="0" border="0" style="text-align:left;width:100%">
                                       <tbody>
                                                               ...
                                                               <tbody>
                                                                  <tr valign="middle">
                                                                     <td id="mXDP4-chdex" style="min-width: 1px; width: 1387px;">
                                                                        <table id="mXDP4" class="z-hbox" cellpadding="0" cellspacing="0" border="0" style="width: 1387px;">
                                                                           <tbody>
                                                                              <tr valign="top">
                                                                                                                  ...
                                                                                                                  <tr valign="middle">
                                                                                                                     ...
                                                                                                                     <td id="mXDP7-chdex" style="height:100%">
                                                                                                                        <i id="mXDP7" style="width:100px;" class="z-datebox">
                                                                                                                           <input id="datepicker1" class="z-datebox-inp" autocomplete="off" value="" type="text" size="11" style="width: 76px;">
                                                                                                                     ...
                                                                                                                     <td id="mXDP9-chdex" style="height:100%">
                                                                                                                        <i id="mXDP9" style="width:100px;" class="z-datebox">
                                                                                                                           <input id="datepicker2" class="z-datebox-inp" autocomplete="off" value="" type="text" size="11" style="width: 76px;">
                                                                                                                     ...
                                                                                                                     <td id="mXDPa-chdex" style="height:100%"><button type="button" id="submit" style="width:40px;height:40px;" class="z-button-os">GO</button></td>
                                                                                                                  </tr>
                                                                                                               </tbody>
                                                                                                            </table>
                                                                                                         </td>
                                          ...
                                          <tr id="mXDPb-chdex" valign="top" style="height: 601px; width: 1391px;">
                                             <td align="left" style="min-width: 1px;">
                                                <table id="mXDPb" class="z-hbox" cellpadding="0" cellspacing="0" border="0" style="height: 601px; width: 1391px;">
                                                   <tbody>
                                                      <tr valign="top">
                                                               ...
                                                               <tbody>
                                                                  <tr valign="top">
                                                                     <td id="mXDPc-chdex" style="min-width: 1px; height: 601px; width: 1391px;">
                                                                        <div id="mXDPc" style="height: 599px; width: 1389px;" class="z-grid">
                                                                           <div id="mXDPc-head" class="z-grid-header" style="width: 1372px;">
                                                                              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="table-layout: fixed; width: 1406px;">
                                                                                 <tbody style="visibility:hidden;height:0px">
                                                                                    <tr id="mXDPh-hdfaker" class="z-grid-faker">
                                                                                       <th id="mXDPq-hdfaker" style="text-align: center; width: 124px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPr-hdfaker" style="text-align: center; width: 65px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPs-hdfaker" style="text-align: center; width: 60px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPt-hdfaker" style="text-align: center; width: 56px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPu-hdfaker" style="text-align: center; width: 30px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPv-hdfaker" style="text-align: center; width: 43px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPx-hdfaker" style="text-align: center; width: 36px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPz-hdfaker" style="text-align: center; width: 41px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP_0-hdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP00-hdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP10-hdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP20-hdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP30-hdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP40-hdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP50-hdfaker" style="text-align: center; width: 30px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP60-hdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP70-hdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP80-hdfaker" style="text-align: center; width: 33px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP90-hdfaker" style="text-align: center; width: 33px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPa0-hdfaker" style="display: none; width: 0px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPb0-hdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPc0-hdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPe0-hdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPg0-hdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPi0-hdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPj0-hdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPl0-hdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPn0-hdfaker" class="z-column" style="width: 36px;">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPh-hdfakerflex" style="width: 69px;"></th>
                                                                                    </tr>
                                                                                 </tbody>
                                                                                 <tbody>
                                                                                    ...
                                                                                    <tr id="mXDPh" class="z-columns" align="left">
                                                                                       <th id="mXDPq" style="text-align: center; width: 120px;" class="z-column">
                                                                                          <div id="mXDPq-cave" class="z-column-cnt" style="text-align: center; width: 112px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             Comments
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPr" style="text-align: center; width: 61px;" class="z-column">
                                                                                          <div id="mXDPr-cave" class="z-column-cnt" style="text-align: center; width: 53px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             Exception
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPs" style="text-align: center; width: 56px;" class="z-column">
                                                                                          <div id="mXDPs-cave" class="z-column-cnt" style="text-align: center; width: 48px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             DOW
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPt" style="text-align: center; width: 52px;" class="z-column">
                                                                                          <div id="mXDPt-cave" class="z-column-cnt" style="text-align: center; width: 44px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             Date
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPu" style="text-align: center; width: 26px;" class="z-column">
                                                                                          <div id="mXDPu-cave" class="z-column-cnt" style="text-align: center; width: 18px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             A/F
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPv" style="text-align: center; width: 39px;" class="z-column">
                                                                                          <div id="mXDPv-cave" class="z-column-cnt" style="text-align: center; width: 31px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             <span id="mXDPw" class="z-label">Tot <br>
                                                                                             Occ%</span>
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPx" style="text-align: center; width: 32px;" class="z-column">
                                                                                          <div id="mXDPx-cave" class="z-column-cnt" style="text-align: center; width: 24px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             <span id="mXDPy" class="z-label">Occ <br>
                                                                                             Rms</span>
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPz" style="text-align: center; width: 37px;" class="z-column">
                                                                                          <div id="mXDPz-cave" class="z-column-cnt" style="text-align: center; width: 29px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             LRR
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDP_0" style="text-align: center; width: 25px;" class="z-column">
                                                                                          <div id="mXDP_0-cave" class="z-column-cnt" style="text-align: center; width: 17px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             A/0
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDP00" style="text-align: center; width: 25px;" class="z-column">
                                                                                          <div id="mXDP00-cave" class="z-column-cnt" style="text-align: center; width: 17px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             B/1
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDP10" style="text-align: center; width: 25px;" class="z-column">
                                                                                          <div id="mXDP10-cave" class="z-column-cnt" style="text-align: center; width: 17px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             C/2
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDP20" style="text-align: center; width: 25px;" class="z-column">
                                                                                          <div id="mXDP20-cave" class="z-column-cnt" style="text-align: center; width: 17px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             D/3
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDP30" style="text-align: center; width: 25px;" class="z-column">
                                                                                          <div id="mXDP30-cave" class="z-column-cnt" style="text-align: center; width: 17px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             E/4
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDP40" style="text-align: center; width: 25px;" class="z-column">
                                                                                          <div id="mXDP40-cave" class="z-column-cnt" style="text-align: center; width: 17px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             F/5
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDP50" style="text-align: center; width: 26px;" class="z-column">
                                                                                          <div id="mXDP50-cave" class="z-column-cnt" style="text-align: center; width: 18px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             G/6
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDP60" style="text-align: center; width: 25px;" class="z-column">
                                                                                          <div id="mXDP60-cave" class="z-column-cnt" style="text-align: center; width: 17px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             H/7
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDP70" style="text-align: center; width: 25px;" class="z-column">
                                                                                          <div id="mXDP70-cave" class="z-column-cnt" style="text-align: center; width: 17px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             I/8
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDP80" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div id="mXDP80-cave" class="z-column-cnt" style="text-align: center; width: 21px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             HP1
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDP90" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div id="mXDP90-cave" class="z-column-cnt" style="text-align: center; width: 21px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             HP2
                                                                                          </div>
                                                                                       </th>
                                                                                       ...
                                                                                       <th id="mXDPb0" style="text-align: center; width: 70px;" class="z-column">
                                                                                          <div id="mXDPb0-cave" class="z-column-cnt" style="text-align: center; width: 62px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             Trans
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPc0" style="text-align: center; width: 70px;" class="z-column">
                                                                                          <div id="mXDPc0-cave" class="z-column-cnt" style="text-align: center; width: 62px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             <span id="mXDPd0" class="z-label">Group <br>
                                                                                             Block</span>
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPe0" style="text-align: center; width: 70px;" class="z-column">
                                                                                          <div id="mXDPe0-cave" class="z-column-cnt" style="text-align: center; width: 62px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             <span id="mXDPf0" class="z-label">Group <br>
                                                                                             P/U</span>
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPg0" style="text-align: center; width: 70px;" class="z-column">
                                                                                          <div id="mXDPg0-cave" class="z-column-cnt" style="text-align: center; width: 62px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             <span id="mXDPh0" class="z-label">Group <br>
                                                                                             Remain</span>
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPi0" style="text-align: center; width: 70px;" class="z-column">
                                                                                          <div id="mXDPi0-cave" class="z-column-cnt" style="text-align: center; width: 62px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             Contract
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPj0" style="text-align: center; width: 70px;" class="z-column">
                                                                                          <div id="mXDPj0-cave" class="z-column-cnt" style="text-align: center; width: 62px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             <span id="mXDPk0" class="z-label">Demand <br>
                                                                                             TD</span>
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPl0" style="text-align: center; width: 70px;" class="z-column">
                                                                                          <div id="mXDPl0-cave" class="z-column-cnt" style="text-align: center; width: 62px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                                             <span id="mXDPm0" class="z-label">Price <br>
                                                                                             TD</span>
                                                                                          </div>
                                                                                       </th>
                                                                                       <th id="mXDPn0" class="z-column" style="width: 33px;">
                                                                                          <div id="mXDPn0-cave" class="z-column-cnt" style="width: 25px;">
                                                                                             <div class="z-column-sort-img"></div>
                                                                           ...
                                                                           <div id="mXDPc-body" class="z-grid-body z-word-nowrap" style="overflow-x: hidden; height: 514px; width: 1389px;">
                                                                              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="table-layout: fixed; width: 1406px;">
                                                                                 <tbody style="visibility:hidden;height:0px">
                                                                                    <tr id="mXDPh-bdfaker" class="z-grid-faker">
                                                                                       <th id="mXDPq-bdfaker" style="text-align: center; width: 124px;" class="z-column ">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPr-bdfaker" style="text-align: center; width: 65px;" class="z-column " >
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPs-bdfaker" style="text-align: center; width: 60px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPt-bdfaker" style="text-align: center; width: 56px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPu-bdfaker" style="text-align: center; width: 30px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPv-bdfaker" style="text-align: center; width: 43px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPx-bdfaker" style="text-align: center; width: 36px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPz-bdfaker" style="text-align: center; width: 41px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP_0-bdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP00-bdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP10-bdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP20-bdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP30-bdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP40-bdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP50-bdfaker" style="text-align: center; width: 30px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP60-bdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP70-bdfaker" style="text-align: center; width: 29px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP80-bdfaker" style="text-align: center; width: 33px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDP90-bdfaker" style="text-align: center; width: 33px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPa0-bdfaker" style="display: none; width: 0px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPb0-bdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPc0-bdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPe0-bdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPg0-bdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPi0-bdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPj0-bdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPl0-bdfaker" style="text-align: center; width: 74px;" class="z-column">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                                       <th id="mXDPn0-bdfaker" class="z-column" style="width: 36px;">
                                                                                          <div style="overflow:hidden"></div>
                                                                                       </th>
                                                                           ...
                                                                           <div id="mXDPc-frozen" class="z-grid-frozen">
                                                                              <div id="mXDPf" style="height: 17px; background: rgb(223, 222, 216);" class="z-frozen">
                                                                                 <div id="mXDPf-cave" class="z-frozen-body" style="height: 17px; width: 750px;">
                                                                                    <div id="mXDPg" style="padding: 0 10px;" class="z-div"></div>
                                                                                 </div>
                                                                                 <div id="mXDPf-scrollX" class="z-frozen-inner" tabindex="-1" style="height: 17px; width: 639px;">
                                                                                    <div style="height: 17px; width: 1089px;"></div>
                                                                                 </div>
